...
describe('ArbitrageService', () => {
  ...
  beforeEach(() => {
    ...
    mockQueueService = new QueueService(() => Promise.resolve()) as jest.Mocked<QueueService>;
    ...
    arbitrageService = new ArbitrageService('0x5de4111afa1a4b94908f83103eb1f1706367c2e68ca870fc3fb9a804cdab365a');
  });
  ...
  describe('Error Handling', () => {
    it('should handle network errors gracefully', async () => {
      ...
      await expect(arbitrageService.manualScan()).rejects.toThrow('Network error');
    });
  ...
  describe('Event Listening', () => {
    ...
    it('should process events in order', async () => {
      ...
      (QueueService.prototype.addToQueue as jest.Mock).mockImplementation((eventData: SwapEventData) => {
